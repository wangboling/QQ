...
public class AddMessageRequestServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		message.setMessage_type(Integer.parseInt(req.getParameter(Messagedb.MESSAGE_TYPE)));
		
		//������ݿⷽ�����в��������ܷ���ֵ
		Map map = DAOFactory.getMessageDao().addMessageRequest(message);
		//�ѷ���ֵת����json��ʽ���ҷ��ؿͻ���
