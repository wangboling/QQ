...
public class GetFriendByToIdServlet extends HttpServlet {
	...
	static {
		...
		try {
			properties.load(GetFriendByToIdServlet.class.getResourceAsStream("/DB.properties"));
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		//������ݿⷽ�����в��������ܷ���ֵ
		Map map = null;
		map= DAOFactory.getUserDAO().getFriendByToId(user);
